...
class ProductGUI:
    def __init__(self):
        ...
        layout1 = [[sg.Text('Search with:', size=15),
                    sg.Combo(['id', 'name', 'count', 'price', 'discount', 'remain', 'type', 'status'],
                   ...
                   [sg.Text('Status:', size=15),
                    sg.Combo(values=["Hoạt động", "Không hoạt động"], default_value="Hoạt động", key=self.Headings[7])],
        ...
        while True:
            ...
            # onCLick element of table
                ...
                if selected_row:
                    ...
                    data = {"id": id[2:], "name": name, "price": price, "product_type_id": type_id,
                            "is_active": is_active}
