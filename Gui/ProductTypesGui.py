...
class ProductTypeGUI:
    def __init__(self):
        ...
        layout1 = [[sg.Text('Search with:', size=15),
                    sg.Combo(['id', 'name', 'is_active'], default_value="id", key='-COMBO_SEARCH-', enable_events=True),
                   ...
                   [sg.Text('Status:', size=15),
                    sg.Combo(key=self.Headings[2], values=["Hoạt động", "Không hoạt động"], default_value="Hoạt động")],
