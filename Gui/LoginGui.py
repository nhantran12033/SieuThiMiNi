...
class LoginGUI:
    def __init__(self):
        ...
        layout = [[sg.Text('Đăng nhập', font=('Helvetica', 20), justification='center')],
                  [sg.Text('Tên đăng nhập:',size=15), sg.InputText(key='username')],
                  [sg.Text('Mật khẩu:',size=15), sg.InputText(key='password', password_char='*')],
                  [sg.Button('Đăng nhập',size=15, bind_return_key=True), sg.Button('Hủy bỏ')]]
