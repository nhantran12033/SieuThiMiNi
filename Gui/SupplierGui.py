...
class SupplierGUI:
    def __init__(self):
        ...
        layout1 = [[sg.Text('Search with:', size=15),
                    sg.Combo(['id', 'name', 'addr', 'status'], default_value="id", key='-COMBO_SEARCH-',
                             enable_events=True), sg.Text('Content:'),
                   ...
                   [sg.Text('Status:', size=15),
                    sg.Combo(values=["Hoạt động", "Không hoạt động"], default_value="Hoạt động", key=self.Headings[3])],
